...
export const resolveNuxtI18nOptions = async (context) => {
  ...
  "global": {
    ...
    "play": (()=>{const fn=(ctx) => {const { normalize: _normalize } = ctx;return _normalize(["Play"])};fn.source="Play";return fn;})(),
    "watch": (()=>{const fn=(ctx) => {const { normalize: _normalize } = ctx;return _normalize(["Watch"])};fn.source="Watch";return fn;})(),
    "watch_trailer": (()=>{const fn=(ctx) => {const { normalize: _normalize } = ctx;return _normalize(["Watch trailer"])};fn.source="Watch trailer";return fn;})(),
    "add_to_watchlist": (()=>{const fn=(ctx) => {const { normalize: _normalize } = ctx;return _normalize(["Add to watchlist"])};fn.source="Add to watchlist";return fn;})(),
    "remove_from_watchlist": (()=>{const fn=(ctx) => {const { normalize: _normalize } = ctx;return _normalize(["Remove from watchlist"])};fn.source="Remove from watchlist";return fn;})(),
    "watchlist": (()=>{const fn=(ctx) => {const { normalize: _normalize } = ctx;return _normalize(["Watchlist"])};fn.source="Watchlist";return fn;})()
  },
  "navigation": {
  ...
  "settings": {
    "title": (()=>{const fn=(ctx) => {const { normalize: _normalize } = ctx;return _normalize(["Settings"])};fn.source="Settings";return fn;})(),
    "description": (()=>{const fn=(ctx) => {const { normalize: _normalize } = ctx;return _normalize(["Here you can change your application settings."])};fn.source="Here you can change your application settings.";return fn;})(),
    "language": (()=>{const fn=(ctx) => {const { normalize: _normalize } = ctx;return _normalize(["Language"])};fn.source="Language";return fn;})()
  },
  "home": {
    "trending": (()=>{const fn=(ctx) => {const { normalize: _normalize } = ctx;return _normalize(["Films and series trending this week"])};fn.source="Films and series trending this week";return fn;})()
  }
},"fr-FR":{
  "global": {
    "hello": (()=>{const fn=(ctx) => {const { normalize: _normalize } = ctx;return _normalize(["Hello World!"])};fn.source="Hello World!";return fn;})(),
    ...
    "genres": (()=>{const fn=(ctx) => {const { normalize: _normalize } = ctx;return _normalize(["Genres"])};fn.source="Genres";return fn;})(),
    "genre": (()=>{const fn=(ctx) => {const { normalize: _normalize } = ctx;return _normalize(["Genre"])};fn.source="Genre";return fn;})(),
    "play": (()=>{const fn=(ctx) => {const { normalize: _normalize } = ctx;return _normalize(["Lecture"])};fn.source="Lecture";return fn;})(),
    "watch": (()=>{const fn=(ctx) => {const { normalize: _normalize } = ctx;return _normalize(["Regarder"])};fn.source="Regarder";return fn;})(),
    "watch_trailer": (()=>{const fn=(ctx) => {const { normalize: _normalize } = ctx;return _normalize(["Regarder la bande-annonce"])};fn.source="Regarder la bande-annonce";return fn;})(),
    "add_to_watchlist": (()=>{const fn=(ctx) => {const { normalize: _normalize } = ctx;return _normalize(["Ajouter à la liste de lecture"])};fn.source="Ajouter à la liste de lecture";return fn;})(),
    "remove_from_watchlist": (()=>{const fn=(ctx) => {const { normalize: _normalize } = ctx;return _normalize(["Supprimer de la liste de lecture"])};fn.source="Supprimer de la liste de lecture";return fn;})(),
    "watchlist": (()=>{const fn=(ctx) => {const { normalize: _normalize } = ctx;return _normalize(["Liste de lecture"])};fn.source="Liste de lecture";return fn;})()
  },
  "navigation": {
  ...
  "settings": {
    "title": (()=>{const fn=(ctx) => {const { normalize: _normalize } = ctx;return _normalize(["Paramètres"])};fn.source="Paramètres";return fn;})(),
    "description": (()=>{const fn=(ctx) => {const { normalize: _normalize } = ctx;return _normalize(["Gérez les paramètres de l'application"])};fn.source="Gérez les paramètres de l'application";return fn;})(),
    "language": (()=>{const fn=(ctx) => {const { normalize: _normalize } = ctx;return _normalize(["Langue"])};fn.source="Langue";return fn;})()
  },
  "home": {
    "trending": (()=>{const fn=(ctx) => {const { normalize: _normalize } = ctx;return _normalize(["Films et séries populaires cette semaine"])};fn.source="Films et séries populaires cette semaine";return fn;})()
  }
},}),})
